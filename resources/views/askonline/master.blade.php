...
<head>
    ...
    <title>Ask Me</title>
    <link href="{{asset("askonline/css/bootstrap.css")}}" rel="stylesheet" type="text/css">
    <link href="{{asset("askonline/css/style.css")}}" rel="stylesheet" type="text/css">
    <link href="{{asset("askonline/css/animate.css")}}" rel="stylesheet" type="text/css">
    <link href="{{asset("askonline/css/font-awesome.min.css")}}" rel="stylesheet" type="text/css"> </head>
        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="{{asset("askonline/image/logo.png")}}" alt="Logo"></a>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="left-user12923 left-user12923-repeat">
                                            <a href="#"><img src="{{asset("askonline/image/images.png")}}" alt="image"> </a> <a href="#"><i class="fa fa-check" aria-hidden="true"></i></a> </div>
                                    </div>
                                    <div class="col-md-9">
...
<small>To youtube Feed</small>
    ...
    <script src="{{asset("askonline/js/jquery-3.1.1.min.js")}}"></script>
    <script src="{{asset("askonline/js/bootstrap.min.js")}}"></script>
    <script src="{{asset("askonline/js/npm.js")}}"></script>
</body>
